...
<tr class="<?php echo $v['isdelete']?'error':''; ?>
   <?php echo $v['istop']?'success':''; ?>">
<td>
<?=$v['index']?>
</td>
<td>
...
<small title="<?=$v['addat']?>"><?php echo date('Y-m-d',strtotime($v[addat])); ?></small>
</td>
<td>
<?php if(!$v['istop']) { ?>
...
<a type="button" class="btn <?php echo $_GET['nohide']?'active':'' ?>"
href="<?=$nowurl?>&nohide=<?php echo $_GET['nohide']?'0':'1' ?>" >只显示可见的</a>
<a type="button" class="btn <?php echo $_GET['nodelete']?'active':'' ?>"
href="<?=$nowurl?>&nodelete=<?php echo $_GET['nodelete']?'0':'1' ?>" >隐藏删除的</a>
</div>
</td>
</tr>
</tfoot>
